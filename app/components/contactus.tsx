  ...
  return (
    <>
      <div className="p-4" id="getstarted">
        <div className="text-center p-15"></div>
        <div className="grid lg:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-6xl max-lg:max-w-2xl mb-10">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <input
              ...
              className="w-full text-slate-100 rounded-full py-2.5 px-4 border border-gray-500 text-sm outline-0 focus:border-blue-500"
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              className="w-full text-slate-100 rounded-md px-4 border border-gray-500 text-sm pt-2.5 outline-0 focus:border-blue-500"
            ></textarea>
            <button
              type="submit"
        ...
        <div className="text-center p-15">
          <BlurFadeText
            title="Get in touch"
            subtitle="Feel free to contact us with your projects"
          />
        </div>
      </div>
    </>
